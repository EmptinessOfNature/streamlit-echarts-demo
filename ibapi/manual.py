...
def main():
    ...
    app.reqCurrentTime()
    print('reqManagedAccts')
    print(app.reqManagedAccts())
    print(app.reqAccountSummary(reqId = 2, groupName = "All",
                                 tags = "NetLiquidation"))
